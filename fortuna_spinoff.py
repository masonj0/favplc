...
USA_DISCOVERY_ADAPTERS: Final[set] = {"Equibase", "TwinSpires"}
INT_DISCOVERY_ADAPTERS: Final[set] = set()

USA_RESULTS_ADAPTERS: Final[set] = set()
INT_RESULTS_ADAPTERS: Final[set] = set()
